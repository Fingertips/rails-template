...
Authentication-Needed-San
  Redirects unauthenticated users around
Peiji-San
  Pagination based on named scopes
Risosu-San
  Nested resource extensions for ActionController
Validates Email-San
  Email validation for ActiveRecord
Generator-San
  Lean Rails generator
On-Test-Spec
  test-spec extensions to make Rails testing easier
